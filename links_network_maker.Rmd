...
Let's switch the to/from node information for all NA oneway values, and then assign those NA values TF. Then we will change the TF and B to 1 and 0. 
...
write_csv(linksFileExcel,"links.csv")
```
